...
class HomeController extends \Think\Controller
{
	...
	{
	    $isOkIp = ip_astrict_num();
	    if(!$isOkIp){
            $this->error("不要操作太频繁！");
        }
		$allow_controller = array("Index","Ajax","Api","Article","Puble","Wokerman","Finance","Login","Queue","Trade","Backstage","Exchange","Pay","User","Chart","Issue","Ptpbc","News","Reward", "Game","Financing","Issue");
