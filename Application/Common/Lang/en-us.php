...
return [
    ...
    "我要买入"                 => "Buy",
    "重置密码"                 => "Reset",
    "关于WSEX正式上线营运的公告" => "WSEX officially launched the operation of the notice",
    "关于ASTC都盟链上线Wall Streetex的公告" => "About ASTC tumeng chain online Wall Streetex notice",
    "WESX-全球数字资产交易服务商" => "WESX-Global digital asset trading service provider",
    ...
    "法律声明"                                                                                                              => "Legal ",
    "常见问题"                                                                                                              => "Q & A",
//    "活动公告"                                                                                                              => "Activity Notices",
//    "新币上线"                                                                                                              => "New Online",
    "最新公告"                                                                                                              => "NEW Notices",
    "文章创建时间："                                                                                                        => "Creation time：",
//    "关于平台"                                                                                                              => "Platform",
    "条款说明"                                                                                                              => "Stipulation",
    "文章更新时间："                                                                                                        => "Article update time：",
    "WSEX 帮助中心"                                                                                                         => "WSEX Help Center",
    "注册邀请奖励活动调整通知"                                                                                              => "Sign up for a reward notice",
    "活动奖励调整公告"                                                                                                       => "Activity announcement",
    "Wall Streetex平台正式上线活动公告"                                                                                     => "Wall Streetex Platform officially launched activities notice",
    "Wall Streetex 开放 Beta 交易"                                                                                         => "Wall Streetex Platform officially launched activities notice",
    "9月4日14:00上线Super Finance Chain (SUF)"                                                                            => "Wall Streetex Platform officially launched activities notice",
    "交易规则"                                                                                                              => "Trade Rule",
    "交易入门"                                                                                                              => "Trading",
    "注册流程"                                                                                                              => "Reg Step",
    "交易指南"                                                                                                              => "Trade Guide",
...
",
    ...
    "联系我们"                                                                          => "Contact Us",
    "HRC全球通用积分"                                                                          => "HRC global general score",
    "用户协议"                                                                          => "User agreement",
    "隐私条款"                                                                          => "Privacy policy",
    "法律声明"                                                                          => "Legal notice",
    "底部"                                                                            => "Bottom",
    ...
    "未通过"                                                                         => "Fail",
    "已通过"                                                                         => "Pass",
    "先通过初级认证"                                                               => "First through the primary certification",
    "初级认证-通过"                                                                         => "The primary authentication-Pass",
    ...
    "证件ID"                                                                         => "ID Number",
    "证件照片"                                                                         => "ID Photo",
    "证件正面"                                                                         => "Certificates for positive",
    "证件反面"                                                                         => "Certificate oppositeo",
    "请填写本人真实身份信息，否则无法正常提现"                                        => "Please fill in your real identity information, otherwise you can't withdraw money normally",
    "请上传清晰的证件照片"                                                             => "Please upload clear id photo",
    "图片支持JPG/PNG/JPEG格式，大小不超过5M"                                         => "Image support JPG/PNG/JPEG format, size no more than 5M",
    "手持证件照通过标准，护照信息清晰，需包括“WSEX”字样和当天日期"                 => "Hold the certificate photo to pass the standard, passport information is clear, including \"WSEX\" and the date of the day",
    "遇到问题联系客服"                                                                  => "Contact customer service if you encounter problems",
    "暂未开放"                                                                           => "Temporarily not opened",
    "账户名称"                                                                           => "Account title",
    "账户资产"                                                                           => "Account balance",

    "买入手续费" =>"Buying charge",
    "卖出手续费" =>"Selling charge",
    "充提费率" =>"Mention filling rate",
    "最小转出数量" =>"Minimum number of rollouts",
    "转入手续费" =>"Transfer fee",
    "费率标准" =>"ate standards",
    "买入手续费" =>"Buying charge",
    ...
    "数字资产交易平台" => "Digital asset trading platform",
	...
	"支持iOS、Android、Windows、Mac等客户端支持全业务功能" => "Support iOS, Android, Windows, Mac and other clients to support full business functions",
    "支持"=>"Support ",
    "iOS、Android、Windows、Mac"=>"iOS、Android、Windows、Mac",
    "等客户端支持全业务功能"=>" and other clients to support full business functionst",
    ...
    "邀请好友注册，轻松获得20HRC糖果奖励" => "Invite friends to register and easily get 20HRC candy award",
    "邀请奖励" => "Invite rewards",
    "邀请规则:" => "Invitation rules:",
	"被邀请者必须完成实名注册" => "Invitees must complete real-name registration",
    "邀请好友的数量上不封顶，不设上限" => "There is no limit on the number of friends invited",
    "佣金返还规则：" => "Commission return rule：",
    "邀请人每邀请一位好友即可获得平台奖励的20HRC糖果奖励 对应糖果奖励将在被邀请人交易次日进行发放" => "Inviter can get 20HRC candy award for each friend invited by the platform Corresponding candy rewards will be distributed the day after the invitee trades",
    "通过邀请二维码邀请好友成功" => "Invite friends to succeed through the invitation qr code",
    "注册" => " registered ",
    "账户" => "account",
	...
	"类别" => "Type",
	"去绑定" => "Go Bindings",
    "手机端用户长按图片保存，电脑端用户右键图片另存为"=>"Mobile phone user long press the picture to save, computer user right click picture as",
    ...
    // 币生币
    "币生币" => "Born COINS COINS",
    "存币" => "Save coin",
    "您手中闲置币种资产，存入平台锁定期限，获得存币收益。" => "If you have idle currency assets in your hand, you can deposit them into the platform for a locked period to earn money.",
    "存入币种" => "In the currency",
    "周期性利率" => "Cyclical interest rate",
    "存入期限" => "Deposited in the period",
    "起存数量" => "Minimum number of",
    ...
    "存币数量" => "Number",
    "利率" => " Rate",
    "累计次数" => "Cumulative number",
    "累计获利" => "Accumulative total profit",
    "存币时间" => "Time",
    "定期" => "Regular",
    "详细记录" => "Record",

    // c2c交易
    "首次充值满1000个USDT，返还总额的 0.5% 换算成等值的HRC" => "First recharge full 1000 USDT,refundable 0.5% amount returned is converted into equivalent HRC",
    "为了您的购买可以快速到账，请在交易前仔细阅读以下注意事项：" => "In order to get your purchase to your account quickly, please read the following notes carefully before trading:",
    "买卖商户均为实名认证商户，并提供保证金，可放心交易；" => "The merchants are real-name verified merchants, and provide security deposit, can be assured of trading;",
    "如需申请成为商户请发邮件到" => "If you want to apply to be a merchant, please send an email to ",
    "请使用本人绑定的银行卡进行汇款，其他任何方式汇款都会退款。（禁止微信和支付宝）" => "Please use the bank card with which you bind to make the remittance. Any other remittance will be refunded. (WeChat and alipay is prohibited)",
    "商家处理时间" => "  Processing time ",
    "非处理时间的订单会在第二天" => "orders with non-processing time will be placed the next day",
    "开始处理，一般接单后24小时内会完成打款。" => "dispose, completed within 24 hours after receiving the order.",
    "单天最多只能发起" => "A maximum of ",
    "笔卖出订单。" => "sales orders can be placed on a single day",
    "单笔交易限额" => "Single transaction limits",
    "单笔提现限额" => "Single withdrawal limit",
