...
<head>
	...
	<link rel="stylesheet" href="/Public/Admin/rh_css/login.css" />
</head>
<body style="background:#f5f6fa;">
<div class="topbox tc">
	<img src="/Public/Admin/rh_img/logo_admin.png">
</div>

<div class="logsbox" style="margin-top:25px;">
	<h2 class="tc" style="margin-bottom:35px;color:#7b7b7b;">管理中心</h2>
	<form action="<?php echo U('Login/index');?>" method="post" id="forms">
		...
		<div class="form-group">
			<div class="inputs" style="width:60%;">
				<i class="icon-login-verifycode"></i>
				<input type="text" name="verify" autocomplete="off" placeholder="图形验证码" id="login_verify" style="width:75%;">
			</div>
			<div class="imgcode">
