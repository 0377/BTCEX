...
<div id="main-content">
	...
	<div id="main" class="main">
		...
		<div class="cf">
			<div class="fl">
				<button class="btn btn-warning" onClick="location.href='<?php echo U('Trade/index');?>'">初始化搜索</button>
			</div>
				...
				<div class="sleft">
					<form name="formSearch" id="formSearch" method="get" name="form1">
						...
						<select style="width: 120px; float: left; margin-right: 10px;" name="bs_type" class="form-control">
							<option value=""
							<?php if(empty($_GET['bs_type'])): ?>selected<?php endif; ?>
							>全部类型</option>
							<option value="1"
							<?php if(($_GET['bs_type']) == "1"): ?>selected<?php endif; ?>
							>买入</option>
							<option value="2"
							<?php if(($_GET['bs_type']) == "2"): ?>selected<?php endif; ?>
							>卖出</option>
						</select>
			...
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<tr>
							<td colspan="12">
								合计统计&nbsp;&nbsp;&nbsp;
								数量：<?php echo ($datas['num_zong']); ?>&nbsp;&nbsp;
								已成交：<?php echo ($datas['num_cj_zong']); ?>&nbsp;&nbsp;
								总额：<?php echo ($datas['money_zong']); ?>
							</td>
						</tr>
