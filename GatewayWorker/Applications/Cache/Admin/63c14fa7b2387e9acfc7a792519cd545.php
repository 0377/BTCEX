						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									...
									<td>
										<select name="sdtype" class="form-control input-10x">
											<option value="0" <?php if(($data["sdtype"]) == "0"): ?>selected<?php endif; ?> >关闭</option>
											<option value="1" <?php if(($data["sdtype"]) == "1"): ?>selected<?php endif; ?> >开启</option>
										</select>
									</td>
									<td class="item-note">使用前需修改文件代码，调用比特儿海外交易所gate.io的价格</td>
								</tr>
								<tr class="controls">
									<td class="item-label">浮动<b style="color:#019CFF;">最高</b>价格:</td>
									<td>
										<input type="text" class="form-control input-10x" name="sdhigh" value="<?php echo ($data["sdhigh"]); ?>">
									</td>
									<td class="item-note">* 当前价:<?php echo ($data["new_price"]); ?>(设置涨跌幅后该设置无效)</td>
								</tr>
								<tr class="controls">
								...
								<tr class="controls">
									<td class="item-label">浮动<b style="color:#019CFF;">最高</b>数量:</td>
									<td>
									...
									<td class="item-note">* 留空默认调用代码内置数量</td>
								</tr>
								<tr class="controls">
