	...
	<div id="main" class="main">
		...
		<div class="cf">
			<div class="fl">
				...
				<a class="btn btn-inverse" target="_blank" href="<?php echo U('Config/ethsenior');?>">ETH钱包高级管理</a>
			</div>
				...
				<div class="sleft">
					<form name="formSearch" id="formSearch" method="get" name="form1">
						...
						<select style="width:160px;float:left;margin-right:10px;" name="field" class="form-control">
							<option value="name" <?php if(($_GET['field']) == "name"): ?>selected<?php endif; ?> >币种简称</option>
							<option value="js_yw" <?php if(($_GET['field']) == "js_yw"): ?>selected<?php endif; ?> >英文名称</option>
							<option value="title" <?php if(($_GET['field']) == "title"): ?>selected<?php endif; ?> >中文名称</option>
						</select>
