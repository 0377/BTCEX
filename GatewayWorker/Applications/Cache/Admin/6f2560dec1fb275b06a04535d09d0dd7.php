						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									...
									<td>
										<select name="jiaoyiqu">
											<?php if(is_array($getCoreConfig)): $i = 0; $__LIST__ = $getCoreConfig;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if(($data["jiaoyiqu"]) == $key): ?>selected<?php endif; ?>><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</td>
								...
								<tr class="controls" style="border-top:1px dashed #d0d0d0;">
									...
									<td>
                                        <?php if(empty($data['fee_buy'])): ?><input type="text" class="form-control input-10x" name="fee_buy" value="0">
										<?php else: ?>
											<input type="text" class="form-control input-10x" name="fee_buy" value="<?php echo ($data["fee_buy"]); ?>"><?php endif; ?>
									</td>
								...
								<tr class="controls">
									...
									<td>
                                        <?php if(empty($data['fee_sell'])): ?><input type="text" class="form-control input-10x" name="fee_sell" value="0">
										<?php else: ?>
											<input type="text" class="form-control input-10x" name="fee_sell" value="<?php echo ($data["fee_sell"]); ?>"><?php endif; ?>
									</td>
									<td class="item-note">% 有挂单的时候不能再修改</td>
								</tr>
								<tr class="controls">
								...
								<tr class="controls">
									...
									<td>
										<select class="form-control input-10x" name="invit_coin">
											<?php if(is_array($C['xnb_list'])): $i = 0; $__LIST__ = $C['xnb_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['name']); ?>" <?php if(($vo['name']) == $data['invit_coin']): ?>selected<?php endif; ?>> <?php echo ($vo['title']); ?>
								...
								<tr class="controls">
									...
									<td>
										<select name="start_time" class="form-control input-10x" style="width:48%;float:left;">
											<?php if(is_array($time_arr)): $k = 0; $__LIST__ = $time_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k-1); ?>"
													<?php if(($data["start_time"]) == $k-1): ?>selected<?php endif; ?>
												><?php echo ($vo); ?>时</option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
										<select name="start_minute" class="form-control input-10x" style="width:48%;float:right;">
											<?php if(is_array($time_minute)): $k = 0; $__LIST__ = $time_minute;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k-1); ?>"
													<?php if(($data["start_minute"]) == $k-1): ?>selected<?php endif; ?>
												><?php echo ($vo); ?>分</option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									...
									<td>
                                        <?php if(empty($data['stop_time'])): ?><select name="stop_time" class="form-control input-10x" style="width:48%;float:left;">
												<?php if(is_array($time_arr)): $k = 0; $__LIST__ = $time_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k-1); ?>" <?php if(($k) == "24"): ?>selected<?php endif; ?>><?php echo ($vo); ?>时</option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										<?php else: ?>
											<select name="stop_time" class="form-control input-10x" style="width:48%;float:left;">
												<?php if(is_array($time_arr)): $k = 0; $__LIST__ = $time_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k-1); ?>" <?php if(($data["stop_time"]) == $k-1): ?>selected<?php endif; ?>><?php echo ($vo); ?>时</option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select><?php endif; ?>
										
                                        <?php if(empty($data['stop_minute'])): ?><select name="stop_minute" class="form-control input-10x" style="width:48%;float:right;">
												<?php if(is_array($time_minute)): $k = 0; $__LIST__ = $time_minute;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k-1); ?>" <?php if(($k) == "60"): ?>selected<?php endif; ?>><?php echo ($vo); ?>分</option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										<?php else: ?>
											<select name="stop_minute" class="form-control input-10x" style="width:48%;float:right;">
												<?php if(is_array($time_minute)): $k = 0; $__LIST__ = $time_minute;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k-1); ?>"<?php if(($data["stop_minute"]) == $k-1): ?>selected<?php endif; ?>><?php echo ($vo); ?>分</option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select><?php endif; ?>
									</td>
								...
								<tr class="controls">
									...
									<td><select name="agree6" class="form-control input-10x">
										<option value="1"
										<?php if(($data["agree6"]) == "1"): ?>selected<?php endif; ?>
										>可交易</option>
										<option value="0"
										<?php if(($data["agree6"]) == "0"): ?>selected<?php endif; ?>
										>不可交易</option>
									</select></td>
									<td class="item-note"></td>
								</tr>
								...
								<tr class="controls">
									...
									<td><select name="agree7" class="form-control input-10x">
										<option value="1"
										<?php if(($data["agree7"]) == "1"): ?>selected<?php endif; ?>
										>可交易</option>
										<option value="0"
										<?php if(($data["agree7"]) == "0"): ?>selected<?php endif; ?>
										>不可交易</option>
									</select></td>
									<td class="item-note"></td>
								</tr>
