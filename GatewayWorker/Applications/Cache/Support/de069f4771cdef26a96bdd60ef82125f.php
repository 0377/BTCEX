...
<div class="container">
	<nav class="sub-nav">
		<ol><?php echo GetPosStr($info['id']);?></ol>
	...
	<div class="category-content wdh100">
		<header class="page-header">
        	<h1><?php echo L($classinfo['title']);?></h1>
		</header>
		
		<div class="section-tree" style="flex-direction:column;">
			<section class="section">
				<ul>
					<?php if(is_array($classify)): $i = 0; $__LIST__ = $classify;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<?php if(($vo["recommend"]) == "1"): ?><img src="/Public/Home/rh_img/recommend.png" /><?php endif; ?>
							<a href="<?php echo U('Support/index/articles/cid/'.$info['id'].'/id/'.$vo['id']);?>"><?php echo ($vo['title']); ?></a>
