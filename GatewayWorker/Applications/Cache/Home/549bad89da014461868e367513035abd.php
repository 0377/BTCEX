...
<link rel="stylesheet" href="/Public/Home/rh_css/fin.css">
...
<!--	<li><a id="menu_3" href="<?php echo U('');?>">RT <?php echo L('分红');?><i></i></a></li>-->
	...
	<div class="fr SettingRight">
		<div class="titles">
			<h3 class="fl"><?php echo L('资产列表');?></h3>
			<span class="fr TotalAssets"><?php echo L('总资产折合');?><b><?php echo ($cny['zj']); ?></b>CNY</span>
		</div>

		<div class="Column_AssetsList">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr class="ColumnTitle">
					<th width="13%" align="center"><?php echo L('币种');?></th>
					<th width="18%" align="center"><?php echo L('可用');?></th>
					<th width="18%" align="center"><?php echo L('冻结');?></th>
					<th width="27%" align="center"><?php echo L('总计');?></th>
					<th width="24%" align="center">&nbsp;</th>
				</tr>
				<?php if(is_array($coinList)): $k = 0; $__LIST__ = $coinList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
						<td>
							<img class="iconimg" src="/Upload/coin/<?php echo ($vo['img']); ?>">
							<span class="sort-coinname"><?php echo ($vo['title']); ?></span>
						</td>
						<td><b><?php echo ($vo['xnb']); ?></b></td>
						<td><b><?php echo ($vo['xnbd']); ?></b></td>
						<td><b><?php echo ($vo['xnbz']); ?></b><span class="zhehe">≈ <?php echo ($vo['zhehe']); ?> CNY</span></td>
						<td class="lasts">
							<?php $acny = Anchor_CNY; ?>
							<?php if(($vo["name"]) == $acny): ?><a class="btns" href="<?php echo U('Exchange/index');?>"><?php echo L('充值');?></a>
								<a class="btns" href="<?php echo U('Exchange/index');?>"><?php echo L('提现');?></a>	
							<?php else: ?>
								<?php if(($vo["type"]) == "ptb"): else: ?>
									<?php if(($vo["zr_jz"]) == "1"): ?><a class="btns" href="<?php echo U('Finance/myzr/coin/'.$vo['name']);?>"><?php echo L('转入');?></a><?php endif; ?>
									<?php if(($vo["zc_jz"]) == "1"): ?><a class="btns" href="<?php echo U('Finance/myzc/coin/'.$vo['name']);?>"><?php echo L('转出');?></a><?php endif; endif; endif; ?>
						</td>
