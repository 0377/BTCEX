 ...
 */
//declare(ticks=1);
/*require_once '/Home/Controller/WokermanController.class.php';*/
//require_once dirname(__FILE__)."/Application/Home/Controller/WokermanController.class.php";
...
class Events
{
   ...
   public static function onMessage($client_id, $message)
   {
       ...
       if(isset($message)){
           ...
           //$url="http://www.jiaoyisuo.com/Wokerman/GetKlineHistory";
           //"http://www.jiaoyisuo.com/Wokerman/getMarketOrdinaryJson"
           //  $url="http://www.jiaoyisuo.com/Wokerman/getMarketOrdinaryJson";
            $where=[
